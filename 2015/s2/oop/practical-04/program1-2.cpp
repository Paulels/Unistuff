...
change the element b[1] to 42 because you havent really copied the array from a into b you have just pointed the values of array b to the values in array a so when a value is changed in a it will also be changed in b.*/
